...
namespace DaiMangou.ProRadarBuilder
{
    ...
    public static class RectExt
    {
        ...
        /// <returns></returns>
        public static Rect ToCenter(this Rect rect, float width = 0, float height = 0, float xPadding = 0, float yPadding = 0)
        {
            Rect result = rect;
            result.position = new Vector2((rect.x + (rect.width / 2)) - (width / 2) + xPadding, (rect.y + (rect.height / 2)) - (height / 2) + yPadding);
            result.width = width;
        ...
        /// <param name="yPadding"></param>
        /// <returns></returns>
        public static Rect ToUpperRight(this Rect rect, float width = 0, float height = 0, float xPadding = 0, float yPadding = 0)
        {
            Rect result = rect;
        ...
        /// <param name="yPadding"></param>
        /// <returns></returns>
        public static Rect ToLowerRight(this Rect rect, float width = 0, float height = 0, float xPadding = 0, float yPadding = 0)
        {
            Rect result = rect;
            result.x = rect.x + rect.width - width + xPadding;
        ...
        /// <param name="yPadding"></param>
        /// <returns></returns>
        public static Rect ToUpperLeft(this Rect rect, float width = 0, float height = 0, float xPadding = 0, float yPadding = 0)
        {
            Rect result = rect;
        ...
        /// <param name="yPadding"></param>
        /// <returns></returns>
        public static Rect ToLowerLeft(this Rect rect, float width = 0, float height = 0, float xPadding = 0, float yPadding = 0)
        {
            Rect result = rect;
            result.x = rect.x + xPadding;
            result.y = rect.y + rect.height - height + yPadding;
        ...
        /// <param name="yPadding"></param>
        /// <returns></returns>
        public static Rect ToCenterTop(this Rect rect, float width = 0, float height = 0, float xPadding = 0, float yPadding = 0)
        {
            Rect result = rect;
            result.position = new Vector2((rect.x + (rect.width / 2)) - (width / 2) + xPadding, rect.y + yPadding);
            result.width = width;
            result.height = height;
            return result;
        ...
        /// <param name="yPadding"></param>
        /// <returns></returns>
        public static Rect ToCenterBottom(this Rect rect, float width = 0, float height = 0, float xPadding = 0, float yPadding = 0)
        {
            Rect result = rect;
            result.position = new Vector2((rect.x + (rect.width / 2)) - (width / 2) + xPadding, rect.y + rect.height - height + yPadding);
            result.width = width;
            result.height = height;
            return result;
        ...
        /// <param name="yPadding"></param>
        /// <returns></returns>
        public static Rect ToCenterLeft(this Rect rect, float width = 0, float height = 0, float xPadding = 0, float yPadding = 0)
        {
            Rect result = rect;
            result.position = new Vector2(rect.x + xPadding, (rect.y + (rect.height / 2)) - (height / 2) + yPadding);
            result.width = width;
            result.height = height;
            return result;
        ...
        /// <param name="yPadding"></param>
        /// <returns></returns>
        public static Rect ToCenterRight(this Rect rect, float width = 0, float height = 0, float xPadding = 0, float yPadding = 0)
        {
            Rect result = rect;
            result.position = new Vector2(rect.x + xPadding + (rect.width - width), (rect.y + (rect.height / 2)) - (height / 2) + yPadding);
            result.width = width;
            result.height = height;
            return result;
    ...
    namespace Editor
    {
        ...
        public class RotationTarget
        {
            ...
            [Obsolete("Please use AddedXRotation")]
        ...
        public class RadarBlips3D
        {
            ...
            /// </summary>
            public Sprite BaseTracker = new Sprite();
            /// <summary>
            /// Prefab blip
            /// </summary>
            public Transform prefab;
        ...
        public class RadarDesign3D
        {
            ...
            /// </summary>
            public bool UseOrthographicForSideSnaps = true;
            /// <summary>
            /// INTERNAL USE ONLY
            /// </summary>
          //  public GameObject DesignsObject;
